...
# FB36 - 20130222
def Generate(width, height, octaves, persistence):
    import random
    import math
    from PIL import Image, ImageDraw
    imgx = width; imgy = height # image size
...
#Suggested params - set octaves equal to peak numbers, and persistance to 0.9